...
public class ChatUI {
	...
	public ChatUI() {
		buildGUI();
		clientId = "ChatGUI"+Long.toString(System.currentTimeMillis()); //TODO should be different for each instance
		//NOTE: producer and consumer topics are opposite of server
		producer = new MessageProducer(null, "chatin", clientId, false);
		consumer = new MyConsumer(null, "chatout");
